...
const aboutContent = {
  ...
  content: {
    ...
    description1: "réalise depuis plus de 2 ans des outils sur-mesure à destination d'entreprises de toutes tailles. Je transforme chaque besoin de mes clients en solution web, en garantissant le respect de leurs règles métiers.",
    btn: {
      href: "/about",
  ...
  content1: {
    ...
    description: "depuis plus de 2 ans des outils sur-mesure à destination d'entreprises de toutes tailles. Je transforme chaque besoin de mes clients en solution web, en garantissant le respect de leurs règles métiers.",
    description1: "plus de 2 ans des outils sur-mesure à destination d'entreprises de toutes tailles. Je transforme chaque besoin de mes clients en solution web, en garantissant le respect de leurs règles métiers.",
      ...
      <div className="container px-4 mx-auto">
          ...
          <div className="lg:w-8/12 lg:flex gap-20 items-center">
            <div className="mb-7 lg:mb-0 lg:w-6/12 lg:order-2 relative">
              <motion.div style={{ y: img1 }} className="z-[2] relative">
                <Image  src="/images/person-6-min.jpg" className="object-cover
            ...
            <div className='lg:w-6/12 mt-10'>
              ...
              <motion.p
                ...
                {aboutContent.content.description}
                {/* console.log({aboutContent.content.description1}); */}
              </motion.p>
            </div>
        ...
        <div className="lg: flex justify-center mt-20">
          <div className="lg:w-8/12 lg:flex gap-20 items-center">
            <div className="mb-7 lg:mb-0 lg:w-6/12 lg:order-2 relative">
              <motion.div style={{ y: img1 }}className="z-[2] relative">
                <Image  src="/images/person-1-min.jpg" className="object-cover
                  !w-full !h-[600] lg:max-w-2xl object-center"
                  width={400} height={600} alt="About Image"
                />
              </motion.div>
            ...
            <div className='lg:w-6/12 mt-10'>
              <motion.h3
                ...
                viewport={ { once: true}}
                className="text-2xl mb-7 text-gray-800">{aboutContent.content1.title}
              </motion.h3>
              {/* About - center - block text */}
              <motion.p
                initial = {{ opacity: 0, y: 10 }}
                ...
                viewport={ { once: true}}
                className="leading-relaxed mb-5 text-gray-500">
                {aboutContent.content1.description}
              </motion.p>
              <motion.p
                initial = {{ opacity: 0, y: 10 }}
                whileInView={{
                ...
                viewport={ { once: true}}
                className="leading-relaxed mb-14 text-gray-500">
                {aboutContent.content1.description1}
              </motion.p>
