          ...
          <div className="w-full py-10" key={packContent.packs[0]}>
            <div className="block md:flex overflow-y-visible items-scretch bg-white rounded-lg md:h-[460px] h-[800px]">
              ...
              <div className="md:w-8/12 md:p-4 flex items-center ">
                <div>
                  <h3 className="text-orange-400 text-center text-[24px] mb-3
                    pt-1 pb-3 duration-300 transistion-all ease-in-out
                    border-b-[1px] border-spacing-[7px] md:pl-20 " >
                      {packContent.packs[0].title}
                  </h3>
                  <ul role="list" className="marker:text-orange-400 list-disc pl-10 md:pl-20 space-y-1 text-gray-500">
                    <li className="list-none text-center text-2xl text-orange-400 pt-1 pb-2">
                      {packContent.packs[0].price}
                      <span className="text-gray-500">/mois</span>
                    </li>
                    <li className="leading-relaxed text-[15px] text-gray-500
                      pt-1 pb-2 duration-300 transistion-all ease-in-out
                       ...
                       <span>
                        {packContent.packs[0].btn && (
                            <motion.btn
                              ...
                              viewport={{ once: true}}>
                              <Link href={packContent.packs[0].btn.href}
                                className=" text-left transistion-all duration-300
                                  ...
                                  hover:shadow-2xl hover:border-[2px] ml-80">
                       ...
                       <span>
                        {packContent.packs[1].btn && (
                            <motion.btn
                              ...
                              viewport={{ once: true}}>
                              <Link href={packContent.packs[1].btn.href}
                                className=" text-left transistion-all duration-300
                                  ease-in-out text-[11.5px] tracking-[2px] font-bold
                                  uppercase bg-orange-600 py-2 px-2 rounded text-white
                                  inline-block hover:bg-white hover:text-orange-600
                       ...
                       <span>
                        {packContent.packs[2].btn && (
                            <motion.btn
                              ...
                              viewport={{ once: true}}>
                              <Link href={packContent.packs[2].btn.href}
                                className=" text-left transistion-all duration-300
                                  ease-in-out text-[11.5px] tracking-[2px] font-bold
                                  uppercase bg-orange-600 py-2 px-2 rounded text-white
                                  inline-block hover:bg-white hover:text-orange-600
                       ...
                       <span>
                        {packContent.packs[3].btn && (
                            <motion.btn
                              ...
                              viewport={{ once: true}}>
                              <Link href={packContent.packs[3].btn.href}
                                className=" text-left transistion-all duration-300
                                  ease-in-out text-[11.5px] tracking-[2px] font-bold
                                  uppercase bg-orange-600 py-2 px-2 rounded text-white
                                  inline-block hover:bg-white hover:text-orange-600
